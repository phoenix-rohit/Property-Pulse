...
function FeaturedPropertyCard({ property }) {
  ...
  return (
    <div className="relative flex flex-col bg-white shadow-md rounded-xl lg:flex-row">
      <Image
        ...
        height={0}
        sizes="100vw"
        className="object-cover w-full rounded-t-xl lg:rounded-tr-none lg:rounded-l-xl lg:w-2/5"
      />
      <div className="p-6">
